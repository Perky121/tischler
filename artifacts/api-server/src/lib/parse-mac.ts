...
export const SYNTAX_RULES = [
  ...
  "Logički operatori: and, or — pišu se između zagrada uvjeta, ne kao funkcija oko svih (operator not se NE koristi u bazi)",
  "Operatori usporedbe: <, >, <=, >=, ==, <> (različito)",
  "Aritmetički operatori: +, -, *, /",
  "Funkcije kuta za rotacije: cos(), sin(), tan(), atan() — uvijek mala slova, vrlo česte u pozicioniranju",
  "Apsolutna vrijednost: abs() ili ABS() — oba oblika postoje, ABS dominira (86%)",
  "Min/Max: MAX(a;b), MIN(a;b) — u stručnim formulama velikim slovima",
  "Spajanje teksta: STRCAT(s1;s2;...) — uvijek VELIKIM slovima (tekst se NE spaja + operatorom)",
  "Zaobljenje/luk u koordinatnom nizu: r(radijus) kao Z-vrijednost točke u @-poligonu označava luk tim polumjerom, npr. [.W];-[.R];r([.R])@",
  "Funkcije round(), int(), sqrt() postoje u jeziku ali se NE koriste u stručnim formulama (0 pojava) — ne predlaži ih",
